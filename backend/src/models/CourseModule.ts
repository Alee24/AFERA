...
CourseModule.init(
  {
    ...
    title_fr: { type: DataTypes.STRING, allowNull: true, defaultValue: '' },
    title_pt: { type: DataTypes.STRING, allowNull: true, defaultValue: '' },
    title_sw: { type: DataTypes.STRING, allowNull: true, defaultValue: '' },
    description_en: { type: DataTypes.TEXT, allowNull: false },
    description_fr: { type: DataTypes.TEXT, allowNull: true, defaultValue: '' },
    description_pt: { type: DataTypes.TEXT, allowNull: true, defaultValue: '' },
    description_sw: { type: DataTypes.TEXT, allowNull: true, defaultValue: '' },
