...
router.post('/users/bulk', authenticateJWT, authorizeRole(['admin']), userController.bulkCreateUsers);
router.post('/admin/users', authenticateJWT, authorizeRole(['admin']), authController.adminCreateUser);
router.post('/admin/users/reset-password', authenticateJWT, authorizeRole(['admin']), authController.adminResetPassword);
router.post('/admin/impersonate/:id', authenticateJWT, authorizeRole(['admin']), authController.impersonateUser);
...
router.post('/finance/credit-notes', authenticateJWT, authorizeRole(['admin']), financeController.issueCreditNote);
